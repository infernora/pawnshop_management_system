        ...
        <div class="container-fluid"> <a class="navbar-toggler ms-sm-auto mx-3 me-md-0 p-2 border-0 text-white"
          ...
          <div class="navbar-collapse collapse" id="navbarCategoryCollapse">
            <ul class="navbar-nav navbar-nav-scroll nav-pills-primary-soft text-center p-0">
              ...
              <li class="nav-item active"> <a class="nav-link" href="cus-item-list.php">Item List</a></li>
      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="bg-slate border p-5 rounded-5" data-aos="fade-up" style="background: linear-gradient(175deg, rgb(104 137 200 / 16%) 0%, rgb(227 93 141 / 12%) 100%)">
            ...
            <form class="filterForm" method="POST" action="cus-item-list.php">
    ...
    <div>
      ...
      <?php
        if($prepared->rowCount() > 0){
          echo '<thead>';
          echo '<tr>';
          echo '<th scope="col"><a href="cus-item-list.php?sort=name">Name</a></th>';
          echo '<th scope="col"><a href="cus-item-list.php?sort=item_id">Item ID</a></th>';
          echo '<th scope="col"><a href="cus-item-list.php?sort=brand">Brand</a></th>';
          echo '<th scope="col"><a href="cus-item-list.php?sort=type">Type</a></th>';
          echo '<th scope="col"><a href="cus-item-list.php?sort=model">Model</a></th>';
          echo '<th scope="col"><a href="cus-item-list.php?sort=status">Status</a></th>';
          echo '<th scope="col"><a href="cus-item-list.php?sort=selling_price">Price</a></th>';
          echo '</tr>';
          echo '<thead>';
          echo '<tbody>';
